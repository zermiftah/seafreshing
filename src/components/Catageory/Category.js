                                ...
                                <div key={product.id}>
                                    ...
                                    <div className="mt-6">
                                        <a
                                            ...
                                            className="relative flex bg-sky-400 border border-transparent rounded-md py-2 px-8 items-center justify-center text-sm font-medium text-sky -900 hover:bg-sky-200"
                                        >
                                            Add to freezer<span className="sr-only">, {product.productName}</span>
                                        </a>
                                    </div>
                                </div>
                            ))}
