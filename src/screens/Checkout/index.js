                                ...
                                userData?.freezer.map((freezer, indexFreezer) => (
                                    <>
                                        ...
                                        <button
                                            ...
                                            className="mt-2 w-full bg-slate-200 border border-transparent rounded-md shadow-sm py-2 px-1 text-base font-medium text-black hover:bg-slate-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-salte-200 focus:ring-slate-800"
                                        >
